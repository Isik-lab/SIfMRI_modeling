    ...
    def run(self):
        ...
        if os.path.exists(self.raw_out_file) and not self.overwrite:
            ...
            try:
                ...
                print('Running rsa...')
                results = neural_alignment.get_rsa_benchmark_results(benchmark, feature_map_extractor, model_uid=self.model_uid, test_eval=True, raw_output_file=self.raw_out_file, input_modal=self.model_input)
